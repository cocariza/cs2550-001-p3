...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const carData = {
    911: {
      ...
      description:
        "The Porsche 911 GT3 RS is the ultimate track-focused version of the legendary 911. With a 4.0L naturally aspirated flat-six producing 518 horsepower, it delivers razor-sharp handling, aggressive aerodynamics, and a 9,000 RPM redline for an exhilarating driving experience. Built for the racetrack but street-legal, it's a masterpiece of precision engineering.",
